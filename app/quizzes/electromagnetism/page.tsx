...
export default function ElectromagnetismQuizPage() {
  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 py-8">
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-3xl font-bold mb-4">Electromagnetism Quiz</h1>
        <p className="text-lg text-muted-foreground">
          Test your knowledge of electromagnetism with this quiz. Select the correct answer for each question.
        </p>
      </motion.div>
