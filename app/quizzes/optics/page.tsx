...
export default function OpticsQuizPage() {
  ...
  const questions = [
    {
      ...
      options: ["n₁sin(θ₁) = n₂sin(θ₂)", "n₁cos(θ₁) = n₂cos(θ₂)", "n₁tan(θ₁) = n₂tan(θ₂)", "n₁θ₁ = n₂θ₂"],
    ...
    },
    {
      ...
      options: ["Convex lens", "Concave lens", "Bifocal lens", "Toric lens"],
      correctAnswer: "Concave lens",
    },
    {
      question: "What phenomenon causes a rainbow to form?",
      options: ["Diffraction", "Reflection", "Refraction and internal reflection", "Polarization"],
      correctAnswer: "Refraction and internal reflection",
    },
    {
      question:
        "What is the minimum angle required for total internal reflection to occur when light travels from glass (n=1.5) to air (n=1)?",
      options: ["30°", "41.4°", "45°", "60°"],
      correctAnswer: "41.4°",
    },
  ]
  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 py-8">
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-3xl font-bold mb-4">Optics Quiz</h1>
        <p className="text-lg text-muted-foreground">
          Test your knowledge of optics with this quiz. Select the correct answer for each question.
        </p>
      </motion.div>
        ...
        >
          <Card className="border-0 shadow-sm bg-gradient-to-br from-green-50 to-white">
            ...
            <CardFooter className="flex justify-between">
              ...
              <div>
                {!isSubmitted ? (
                  <Button onClick={handleSubmit} disabled={!selectedAnswer} className="bg-green-600 hover:bg-green-700">
                    Submit
                  </Button>
                ) : (
        ...
        >
          <Card className="border-0 shadow-sm bg-gradient-to-br from-green-50 to-white">
            <CardContent className="pt-6 pb-6">
              ...
              <div className="text-6xl font-bold mb-6 text-green-600">
